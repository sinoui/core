  ...
  return (
    <ThemeProvider theme={defaultTheme}>
      <>
        ...
        <StyledIconButton color="primary" selected={selected}>
          <SvgIcon outlined={!selected} />
        </StyledIconButton>
        <StyledIconButton color="secondary" selected={selected}>
          <SvgIcon outlined={!selected} />
        </StyledIconButton>
        <StyledIconButton color="error" selected={selected}>
          <SvgIcon outlined={!selected} />
        </StyledIconButton>
        <StyledIconButton color="warning" selected={selected}>
          <SvgIcon outlined={!selected} />
        </StyledIconButton>
        <StyledIconButton color="info" selected={selected}>
          <SvgIcon outlined={!selected} />
        </StyledIconButton>
        <StyledIconButton color="success" selected={selected}>
          <SvgIcon outlined={!selected} />
        </StyledIconButton>
